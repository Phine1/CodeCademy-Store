(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var store = (0, _redux.createStore)((0, _redux.combineReducers)({
      ...
      currencyFilter: _CurrencyFilter.currencyFilterReducer,
      inventory: _inventorySlice.inventoryReducer
    }));
    exports.store = store;
    
    },{"../features/cart/cartSlice.js":5,"../features/currencyFilter/CurrencyFilter.js":6,"../features/inventory/inventorySlice.js":9,"redux":undefined}],4:[function(require,module,exports){
    "use strict";
    ...
    var Cart = function Cart(props) {
      ...
      var onInputChangeHandler = function onInputChangeHandler(name, input) {
        ...
        dispatch((0, _cartSlice.changeItemQuantity)(name, newQuantity)); // Otherwise, convert the input into a number and pass it along as the newQuantity.
